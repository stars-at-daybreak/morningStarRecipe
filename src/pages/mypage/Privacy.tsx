...
function Privacy() {
    ...
    return (
        <>
            <title>개인정보 처리방침 - 모두의 부엌</title>
            <meta name='description' content='모두의 부엌 개인정보 처리방침입니다.' />
            <meta name='robots' content='noindex, nofollow' />
            <link rel='canonical' href='https://morningstarrecipe.netlify.app/mypage/privacy' />
            <section className={styles.privacy}>
                <div className={styles.privacy__container}>
                    ...
                    <div className={styles.privacy__content}>
                        ...
                        <div className={styles.privacy__content}>
                            ...
                            <ul className={styles.privacy__content_text}>
                                <li>
                                    ...
                                    비인가 사용방지, 가입의사 확인, 연령확인, 만14세 미만 아동 개인정보 수집 시 법정
                                    대리인 동의여부 확인, 불만처리 등 민원처리, 고지사항 전달
                                </li>
                                <li>
                                    서비스 제공: 요리 레시피 맞춤 추천, 콘텐츠 제공, 구매 및 요금 결제, 물품배송 또는
                                    청구서 등 발송, 본인인증, 연령인증, 서비스 이용기록과 접속빈도 분석, 서비스 이용의
                                    유효성 확인, 개인화 서비스 제공
                                </li>
                                <li>
                                    마케팅 및 광고: 신규 서비스(제품) 개발 및 특화, 이벤트 등 광고성 정보 전달,
                        ...
                        <div className={styles.privacy__content}>
                            <strong className={styles.privacy__sub_title}>
                                4. 개인정보의 보유 및 이용기간 회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외
                                없이 해당 정보를 지체없이 파기합니다.
                            </strong>
                            ...
                            <ul className={styles.privacy__content_text}>
                                ...
                                <li>
                                    ...
                                    통신비밀보호법 등 관련 법령에서 일정기간 정보의 보관을 규정하는 경우에는 해당 기간
                                    동안 보관합니다
                        ...
                        <div className={styles.privacy__content}>
                            ...
                            <ul className={styles.privacy__content_text}>
                                <li>
                                    회원님이 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의
                                    서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간
                        ...
                        <div className={styles.privacy__content}>
                            <strong className={styles.privacy__sub_title}>
                                6. 개인정보 제공 및 공유 회사는 이용자들의 개인정보를 "개인정보의 수집목적 및
                                이용목적"에서 고지한 범위 내에서 사용하며, 이용자의 사전 동의 없이는 동 범위를 초과하여
                        ...
                        <div className={styles.privacy__content}>
                            ...
                            <ul className={styles.privacy__content_text}>
                                ...
                                <li>
                                    설치•운영 및 거부: 웹브라우저 상단의 도구 → 인터넷 옵션 → 개인정보 메뉴의 옵션
                        ...
                        <div className={styles.privacy__content}>
                            ...
                            <ul className={styles.privacy__content_text}>
                                ...
                                <li>
                                    ...
                                    연락주시기 바랍니다. 귀하는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호
                                    관련 민원을 개인정보보호책임자 혹은 담당부서로 신고하실 수 있습니다. <br />
